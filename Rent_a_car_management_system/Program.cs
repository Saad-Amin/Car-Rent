...
namespace ConsoleApp20
{
    class Program
    {
        public static void ClassSelection(char dc)
        {
            {
                switch (dc)
                {
        ...
        public static void ClassA(int ab)
        {
            switch (ab)
            {
                case 1:
        ...
        public static void ClassB(int ab)
        {
            switch (ab)
            {
                case 1:
        ...
        public static void final(string ans, int ab)
        {
            while (true)
            {
                if (ans == "YES" || ans == "yes" || ans == "Yes")
                {
                    ...
                    string[] file = new string[6] { "Car Number: " + ab, "Name: " + name, "Cnic: " + nic, "Date: " + date, "Time: " + time, "Driver: " + driver };
        ...
        back: Console.WriteLine("                                                                 CREATE A USERNAME");
            ...
            Console.WriteLine();
            FileStream fs = new FileStream("Login.txt", FileMode.Append, FileAccess.Write);
